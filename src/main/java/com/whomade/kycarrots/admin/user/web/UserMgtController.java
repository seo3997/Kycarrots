...
public class UserMgtController {
	...
	public String insertFormUserMgt(HttpServletRequest request, HttpServletResponse response, ModelMap model)
		...
		// 지점 리스트 조회
		List branchList = mgtBranchService.selectListBranch(param);
	...
	public @ResponseBody void selectUserMgtAjax(HttpServletRequest request, HttpServletResponse response,
	...
	public @ResponseBody void updateUserMgtAjax(HttpServletRequest request, HttpServletResponse response,
			ModelMap model) throws Exception {
		...
		if (!param.getString("modal_password").equals("")) {
			// String endPassword =
			// EgovFileScrty.encryptSHA512(param.getString("modal_password"));
	...
	public @ResponseBody void selectIdExistYnAjax(HttpServletRequest request, HttpServletResponse response,
			ModelMap model) throws Exception {
