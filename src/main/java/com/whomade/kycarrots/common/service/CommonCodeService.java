...
public interface CommonCodeService {
	 ...
	 * @throws Exception
	 */
	List<DataMap> selectCodeList(DataMap dataMap) throws Exception;

	List<DataMap> selectSCodeList(DataMap dataMap) throws Exception;

	List<DataMap> selectSDCodeList(DataMap dataMap) throws Exception;
}
