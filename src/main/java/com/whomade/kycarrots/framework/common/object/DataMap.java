 ...
 * 0. Project  : XXXX 프로젝트
 *
 * 1. FileName : DataMap.java
 * 2. Package : framework.common.object
 * 3. Comment : 
 * 4. 작성자  : SooHyun.Seo
 ...
 *    이름     : 일자          : 근거자료   : 변경내용
 *    ------------------------------------------------------
 *    SooHyun.Seo : 2013. 8. 14. :            : 신규 개발.
 */

package com.whomade.kycarrots.framework.common.object;
