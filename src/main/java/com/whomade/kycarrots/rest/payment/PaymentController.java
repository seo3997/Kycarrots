...
public class PaymentController {
    ...
    @Operation(summary = "주문서 생성", description = "토스 결제창 호출 전, 서버에 주문 정보를 미리 생성합니다.", responses = {
            @ApiResponse(responseCode = "200", description = "성공 (주문성공)", content = @Content(schema = @Schema(type = "object", example = "{ \"success\": true, \"orderId\": 123, \"orderNo\": \"ORDER-1708348400000\" }")))
    })
