...
public class FrontMainController {
	...
	public void savePlanFAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
		DataMap param = RequestUtil.getDataMap(request);
		model.addAttribute("param", param);
	...
	public void calPlanFAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
		DataMap param = RequestUtil.getDataMap(request);
		model.addAttribute("param", param);
		response.setContentType("text/html; charset=utf-8");
		...
		// 제조경비 판매관리비 감각상각 비용
		Long[] yDpreMAmtArr = PlanFUtil.getItemYAmtFindArr(jMCOST.getJSONArray("MCost"), "MCostTitle", "감가상각비",
				jMCOST.getJSONArray("MCostY"), "YMCostAmtYear");
		Long[] yDpreSAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostTitle", "감가상각비",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		...
		Long[] yYSaleMAmtArr = PlanFUtil.getItemYAmtFindArr(jMCOST.getJSONArray("MCost"), "MCostCd", "매출액",
				jMCOST.getJSONArray("MCostY"), "YMCostAmtYear");
		Long[] yYSaleSAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostCd", "매출액",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		...
		Long[] yYJob01MAmtArr = PlanFUtil.getItemYAmtFindArr(jMCOST.getJSONArray("MCost"), "MCostCd", "월정액",
				jMCOST.getJSONArray("MCostY"), "YMCostAmtYear");
		Long[] yYJob02MAmtArr = PlanFUtil.getItemYAmtFindArr(jMCOST.getJSONArray("MCost"), "MCostCd", "인건비",
				jMCOST.getJSONArray("MCostY"), "YMCostAmtYear");
		Long[] yYJob03MAmtArr = PlanFUtil.getItemYAmtFindArr(jMCOST.getJSONArray("MCost"), "MCostCd", "기준액",
				jMCOST.getJSONArray("MCostY"), "YMCostAmtYear");
		...
		Long[] yYJob01SAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostCd", "월정액",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		Long[] yYJob02SAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostCd", "인건비",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		Long[] yYJob03SAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostCd", "기준액",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		...
		bizCd = 2;
		// 감가상각비용,대손상가비용
		Long[] yDBedSAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostTitle", "대손상각비",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
		...
		// 월임차료
		Long[] yRentSAmtArr = PlanFUtil.getItemYAmtFindArr(jSCOST.getJSONArray("SCost"), "SCostTitle", "지급임차료",
				jSCOST.getJSONArray("SCostY"), "YSCostAmtYear");
	...
	public String selectPlanF(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
		DataMap param = RequestUtil.getDataMap(request);
	...
	public void listPlanFAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
		DataMap param = RequestUtil.getDataMap(request);
		model.addAttribute("param", param);
		response.setContentType("text/html; charset=utf-8");
