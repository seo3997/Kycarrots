...
public class TbSurveyUserDegree {
	...
	public String getSURVEY_NM() {
		return SURVEY_NM;
	}
	public void setSURVEY_NM(String sURVEY_NM) {
		SURVEY_NM = sURVEY_NM;
	}
	...
	public String getSURVEY_DEGREE() {
		return SURVEY_DEGREE;
	}
	public void setSURVEY_DEGREE(String sURVEY_DEGREE) {
