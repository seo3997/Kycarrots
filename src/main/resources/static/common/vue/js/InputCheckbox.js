          ...
          <tr>
            <td>
              <form @submit.prevent="submitForm">
                ...
                <textarea v-model="formData.prompt" wrap="physical" cols="50" class='span12' rows="3">hhhhhhh</textarea><br><br>
                ...
                <b>Multiple choice options:</b> <font color="#999999">(list one per line, minimum is 1)</font><br>
                <textarea v-model="formData.options" wrap="virtual" cols="50" class='span12' rows="3">option 1 option 2 option 3</textarea><br>
                <br><b>Do you want an &amp;quot;other:&amp;quot; short answer field?</b><br>
                <div class='control-group'>
                  <div class='controls'>
                    <label>
                      <input type="radio" name="otherShortAnswer" value="yes" v-model="formData.otherShortAnswer">
                    ...
                    <label>
                      <input type="radio" name="otherShortAnswer" value="no" v-model="formData.otherShortAnswer">
                      <span class='lbl'>No</span>
                    </label>
                  </div>
                </div><br>
