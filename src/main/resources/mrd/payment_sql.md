...
`PAYMENT_STATUS` varchar(20) NOT NULL COMMENT 'R010670 공통코드',
...
`ORDER_STATUS` varchar(20) NOT NULL COMMENT 'R010650 공통코드',
`BRANCH_DEPOSIT_STATUS` varchar(20) DEFAULT '10' COMMENT 'R010680',
...
ADD COLUMN `DELIVERED_AT` datetime DEFAULT NULL COMMENT '배송 완료 일시' AFTER `SHIPPED_AT`,
ADD COLUMN `CONFIRMED_AT` datetime DEFAULT NULL COMMENT '주문 확정 일시' AFTER `DELIVERED_AT`,
ADD COLUMN `RETURNED_AT` datetime DEFAULT NULL COMMENT '반품 완료 일시' AFTER `CONFIRMED_AT`;
