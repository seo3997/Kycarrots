...
`BASE_SHIPPING_FEE` int DEFAULT '3000' COMMENT '기본 배송비',
`FREE_SHIPPING_THRESHOLD` int DEFAULT '50000' COMMENT '무료배송 기준 금액',
`EXTRA_SHIPPING_FEE` int DEFAULT '3000' COMMENT '도서산간/제주 추가 배송비',
