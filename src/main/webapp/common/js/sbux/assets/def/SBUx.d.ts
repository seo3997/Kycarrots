declare namespace SBUxMethod {
    ...
    function setBreadcrumb(modelName: string, menuValue: any, menuValueKey?: string): void;
    function getBreadcrumb(modelName: string): object;

    function addTab(modelName: string, options: object): void;
    function removeTab(modelName: string, tabIdorOptions: any): void;
    function removeAllTab(modelName: string): void;
    function removeOthersTab(modelName: string, tabId: string): void;
    function getTab(modelName: string, nodeId?: string): object;
