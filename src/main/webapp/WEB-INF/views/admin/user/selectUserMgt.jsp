		...
		<section class="content container-fluid vw-page">
			...
			<div class="card">
				...
				<div class="card-body viewForm">
					...
					<div class="form-group row">
						<label for="" class="control-label col-xs-12 col-sm-3 col-md-3 col-lg-2">사용자 상태</label>
						<div class="col-xs-12 col-sm-9 col-md-3 col-lg-4">
					...
					<div class="form-group row">
						<label for="" class="control-label col-xs-12 col-sm-3 col-md-3 col-lg-2">지역</label>
