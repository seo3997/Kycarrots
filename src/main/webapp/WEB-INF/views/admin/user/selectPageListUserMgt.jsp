...
<jsp:useBean id="authList"   			class="java.util.ArrayList" type="java.util.List" 						scope="request"/>
					...
					<div class="box-header">
						<div class="col-12 form-row">
							...
							<div class="row col-md-6 mb-1 form-group form-inline">
								<label for="sch_user_author" class="control-label col-md-2 px-0">권한명</label>
								<div class="col-md-9  px-0">
									<%
									String sel = param.getString("sch_user_author"); // 파라미터 값 (없으면 null/빈문자)
									if (sel != null) sel = sel.trim();
									%>

									<select id="sch_user_author" name="sch_user_author" class="form-control w-100" style="font-size:14px">
									  <option value="" <%= (sel == null || sel.isEmpty()) ? "selected" : "" %>>전체</option>
									  <%
										for (int i = 0; i < authList.size(); i++) {
										  DataMap authMap = (DataMap) authList.get(i);
										  String val = authMap.getString("AUTHOR_ID");
										  String nm  = authMap.getString("AUTHOR_NM");
									  %>
										<option value="<%= val %>" <%= (sel != null && sel.equals(val)) ? "selected" : "" %>><%= nm %></option>
									  <%
										}
									  %>
									</select>
							...
							<!-- 2. 사용자 상태로 검색  -->
							<div class="row col-md-6 mb-1 form-group form-inline">
								<label for="sch_user_sttus_code" class="control-label col-md-2 px-0">사용자 상태</label>
								<div class="col-md-9 px-0">
							...
							<!-- 상세검색 -->
							<div class="row col-md-6 mb-1 form-group form-inline">
								<label for="sch_type" class="control-label col-md-2 px-0">상세검색</label>
							...
							<div class="row col-md-6 mb-1 form-group form-inline">
								<label for="optionsRadios1" class="control-label col-md-1 px-0">가입일</label>
								<div class="row px-0">
