...
<html lang="en">
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<form class="form-horizontal marginbot-clear">  
			...
			<div class="modal-footer">
				<input type="button" id="btnAddMenu" class="btn btn-primary" value="추가 및 수정" @click="btnAddMenuClick()"/>
		...
		<form class="form-horizontal marginbot-clear">  
			<div class="modal-body">
				...
				<table  class="table table-bordered table-striped">
					...
					<tr>
						<td>1차년도</td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostMenuAmtYear1" value="" name="inputCostMenuAmtYear1" placeholder="1차년도 판매금액"></td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostAmtYear1" 	 value="" name="inputCostAmtYear1" placeholder="1차년도 재료비"></td>
					</tr>
					<tr>
						<td>2차년도</td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostMenuAmtYear2" value="" name="inputCostMenuAmtYear2" placeholder="2차년도 판매금액"></td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostAmtYear2" 	 value="" name="inputCostAmtYear2" placeholder="2차년도 재료비"></td>
					</tr>
					<tr>
						<td>3차년도</td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostMenuAmtYear3" value="" name="inputCostMenuAmtYear3" placeholder="3차년도 판매금액"></td>
						<td style="text-align:left;"><input type="text" class="numeric span2" id="inputCostAmtYear3" 	 value="" name="inputCostAmtYear1" placeholder="3차년도 재료비"></td>
					</tr>
			  	</table>
		...
		<form class="form-horizontal marginbot-clear">  
			<div class="modal-body">
				...
				<div class="control-group" style="margin-bottom:5px">
					...
					<div class="controls">
						<select id="inputYJobAmtCd" name="inputYJobAmtCd">
						<option value="1">증감율</option>
						<option value="2">직접입력</option>
						</select>				
					</div>
			...
			<div class="span10">
				...
				<div id="diSale" style="display:none">
					...
					<div class="control-group login-register">
					    <div class="controls">
					        <button id="btnMenu" class="btn btn-small" type="button" @click="btnMenuClick()">+</button>
					    </div>
					</div>
					...
					<table id="menuTableVue" class="table table-bordered table-striped">
						<thead>
							<tr>
							<th width="5%">No</th> <th><span id="smenuTitle">메뉴명</span></th> 
							<th width="17%"><span id="smenuPrice">메뉴가격</span></th> 
							<th width="17%"><span id="smenuQty">일 판매 기준수량</span></th> 
							<th width="17%"><span id="smenuAmt">일 판매 금액</span></th> 
							<th width="10%">수정/삭제</th>
						...
						<tbody>
						<tr class="menuIndex" v-for="menu in planfSale.SALE.menu">
							<td><span name="dmenuIndexVue">1</span></td>
							<td><span name="dmenuTitleVue">{{menu.MenuTitle}}</span></td>
							<td style="text-align: right;"><span name="dmenuPriceVue">{{menu.MenuPrice}}</span>원</td>
							<td style="text-align: right;"><span name="dmenuQtyVue">{{menu.MenuQty}}</span></td>
							<td style="text-align: right;"><span name="dmenuAmtVue">600,000</span>원</td>
							<td style="text-align: center;"><input name="btnUpdMenuVue" value="수정" type="button" class="btn btn-mini"> <input name="btnDelMenuVue" value="삭제" type="button" class="btn btn-mini btn-danger"></td>
						</tr>
						</tbody>
					</table>	
	...
	<script type="text/javascript" src="/common/js/home.js?version=1.04""></script>
	...
	<script>
         ...
         if(""==PLANF_ID){
        	...
        	PLANF_SALE.SALE 	= jsonMenu;
        	PLANF_SALE.COST 	= jsonCost;
        	PLANF_SALE.JOB  	= jsonJob;
        	PLANF_SALE.INVEST= jsonInvest;
        	PLANF_SALE.LOAN  = jsonLoan;
        	PLANF_SALE.MCOST  = jsonMCost;
        	PLANF_SALE.SCOST  = jsonSCost;
			 ...
			 PLANF_SALE    =JSON.parse('<%=planFMap.getString("PLANF_SALE")%>');
	     }

  	 	//initUpdate(industryCd,workDay,monTargetPrice,PLANF_SALE);
	</script>
	...
	<script>
		var app = new Vue({
			  ...
			  methods:{
					initPlanF: function() {
						initUpdate(this.industryCd,this.workDay,this.monTargetPrice,this.planfSale);
					},
					btnMenuClick: function() {
						btnMenuAddClick()
					},
					btnAddMenuClick: function() {
					    let jsonMenu = new Object();
					    jsonMenu.MenuTitle ="F메뉴";
					    jsonMenu.MenuPrice =900000;
					    jsonMenu.MenuQty =3;

						let jsonMenus = new Array();;
					    jsonMenus = PLANF_SALE.SALE.menu;

					    jsonMenus.push(jsonMenu);

					    this.planfSale.SALE.menu = jsonMenus;
