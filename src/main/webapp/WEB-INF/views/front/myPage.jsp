	...
	<section id="contain">
		<div class="container">
		  <div class="row">
			<div class="span2">
				<div class="navaside">
					<ul class="nav menunav">
						<li><a href="/front/myProfit.do"><i class="icon-home"></i> 수익분석 목록</a></li>
						<li class="active"><a href="/front/myPage.do"><i class="icon-pencil"></i> Mypage</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="span10">
				<div>
					<h4 class="heading">Mypage<span></span></h4>
					<p></p>
				</div><!--diDash-->
		    </div><!--span10-->
