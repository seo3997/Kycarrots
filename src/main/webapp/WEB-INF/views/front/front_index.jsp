...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <h1>자연을 담은 프리미엄 농수산물,<br>asagong</h1>
            <p>산지의 신선함을 그대로 식탁까지. 까다롭게 엄선한 최고 품질의 농수산물만을 취급하는 전국 최대 규모의 아는 사람끼리 공동구매 유통 플랫폼입니다.</p>
            <div>
    ...
    <section class="features" id="features">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <h3>극상의 신선도</h3>
                <p>당일 수확, 당일 배송을 원칙으로 산지의 숨결이 살아있는 가장 신선한 농수산물을 제공합니다.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🤝</div>
                <h3>투명한 직거래</h3>
            ...
            <div class="feature-card">
                <div class="feature-icon">✨</div>
                <h3>깐깐한 품질 검증</h3>
                <p>수십 년 경력의 농수산물 전문가들이 맛과 크기, 당도를 직접 확인하여 상위 1%의 프리미엄 상품만 선별합니다.</p>
            </div>
        </div>
    </section>
    ...
    <section class="about" id="about">
        <div class="about-content">
            ...
            <div class="about-text">
                ...
                <p>asagong은 본사를 중심으로 전국 주요 거점에 지점망을 구축하여 가장 빠르고 안전하게 농수산물을 유통하고 있습니다.</p>
                <p>데이터 기반의 수요 예측 시스템과 콜드체인 물류망을 결합하여, 버려지는 농수산물을 최소화하고 지속 가능한 농업 생태계 조성에 앞장서고 있습니다.</p>
