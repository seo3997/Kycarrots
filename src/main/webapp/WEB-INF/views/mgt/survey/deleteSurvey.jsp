...
<% 
	...
	String pageTitle= "Delete Survey" +" &quot;" + survey.getSURVEY_TITLE() + "&quot;";
    int minLenSurveyName=1;
	int maxLenSurveyName=30;
	
	if (!param.getString("deleteSurvey").equals("")) {
	...
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			<div class="tab-content">
				...
				<tr>
					<td>
						<form method="post" action="/mgt/survey/deleteSurvey_ok.do">
						    <font color="#ff0000"><b>Attention</b></font> Are you sure that you want to delete this survey?<br>
						    <br>
						<%
						  if ( surveyId != null )
						    out.print ( "<input type=\"hidden\" name=\"surveyId\" value=\"" + surveyId + "\">" );
						%>
						<input type="submit" name="deleteSurvey" value="Yes, Delete Survey" class="btn btn-primary">&nbsp;
						<input type="button" name="cancel" value="Cancel" class="btn" onClick="self.close();">
						</form>
					</td>
				</tr>
				</tbody>
