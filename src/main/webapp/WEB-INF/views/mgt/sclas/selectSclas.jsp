		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
						...
						<div class="col-xs-6">
							<div class="box box-primary">
								 <h4 class="subtitle"><i></i>품목리스트</h4>
						...
						<div class="col-xs-6">
							...
							<div class="tb-box form-horizontal"">
								<form role="form" id="aform" method="post">
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="attrb_1">HS코드</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" name="attrb_1" id="attrb_1"  />
										</div>
										<label class="control-label col-sm-2" for="attrb_2">AG코드</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" name="attrb_2" id="attrb_2" />
										</div>
									</div>	
									<div class="form-group">
										<label class="control-label col-sm-2" for="attrb_3">수량</label>
										<div class="col-sm-3">
