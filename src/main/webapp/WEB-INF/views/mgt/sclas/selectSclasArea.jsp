		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-body">
								<div class="form-group">
									<label for="group_id">지역(시도)</label>
						...
						<div class="col-xs-6">
							<div class="box box-primary">
								 <h4 class="subtitle"><i></i>지역리스트</h4>
								<div class="box-body table-responsive no-padding">
									<table id="menuTable" class="table table-hover table-bordered">
										...
										<thead>
											<tr>
												<th class="text-center">지역코드</th>
												<th class="text-center">지역명</th>
												<th class="px100 text-center">맵챠트지역코드</th>
												<th class="px100 text-center">위도</th>
												<th class="px100 text-center">경도</th>
												<th class="px100 text-center">순서</th>
											</tr>
										</thead>
										<tbody>
									<%
						...
						<div class="col-xs-6">
							...
							<div class="tb-box form-horizontal"">
								<form role="form" id="aform" method="post">
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="sclas_code">지역코드</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" name="sclas_code" id="sclas_code" />
										</div>
										<label class="control-label col-sm-2" for="sclas_nm">지역명</label>
										<div class="col-sm-3">
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="attrb_1">맵챠트 지역코드</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" name="attrb_1" id="attrb_1"  />
										</div>
										<label class="control-label col-sm-2" for="attrb_2">위도</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" name="attrb_2" id="attrb_2" />
										</div>
									</div>	
									<div class="form-group">
										<label class="control-label col-sm-2" for="attrb_3">경도</label>
										<div class="col-sm-3">
